          ...
          <div className="container py-5">
            ...
            <div className="row justify-content-center mt-4">
              <div className="col-lg-8">
                <div
                  ref={searchSection}
                  className="d-flex border border-primary rounded-3 position-relative"
                ...
                >
                  ...
                  {showDropdown && (
                    <ul
                      className="absolute bg-white border border-gray-300 mt-1 rounded-xl max-h-48 overflow-y-auto shadow-lg text-left"
